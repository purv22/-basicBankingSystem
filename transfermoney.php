...
<body style="background-color :#D1D7E0 ;">
<?php
 include 'config.php';
            ...
            <div class="row">
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : neon;">Transfer</button></a></td> 
                    </tr>
                <?php    
                    }
                ?>
